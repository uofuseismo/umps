...
namespace UMPS::ProxyServices::PacketCache
{
/// @name BulkDataResponse "bulkDataResponse.hpp" "umps/proxyServices/packetCache/bulkDataResponse.hpp"
/// @brief This represents the packet data for multiple sensors.
/// @sa BulkDataRequest
/// @copyright Ben Baker (University of Utah) distributed under the MIT license.
template<class T = double>
class BulkDataResponse : public MessageFormats::IMessage
{
public:
    /// @name Constructors
    /// @{
    ...
    [[nodiscard]] const DataResponse<T> *getDataResponsesPointer() const noexcept;
