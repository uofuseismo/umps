#ifndef UMPS_SERVICES_MODULEREGISTRY_REGISTRATIONRESPONSE_HPP
#define UMPS_SERVICES_MODULEREGISTRY_REGISTRATIONRESPONSE_HPP
#include <memory>
#include "umps/messageFormats/message.hpp"
#include "umps/services/moduleRegistry/enums.hpp"
namespace UMPS::Services::ModuleRegistry
{
/// @class RegistrationResponse registrationResponse.hpp "umps/services/registry/registrationResponse.hpp"
/// @brief Response from a module registration request.
...
public:
    ...
    /// @param[in,out] response  The request from which to initialize this
    ///                          class.  On exit, request's behavior is
    ///                          undefined.
