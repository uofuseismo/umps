...
public:
    ...
    /// @param[in] contents  The text-based contents of the message to set.
    ...
    /// @brief Converts the text class to a string message.
    ...
    /// @result A message type indicating this is a text message.
