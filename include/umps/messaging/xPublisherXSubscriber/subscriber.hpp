#ifndef UMPS_MESSAGING_XPUBLISHER_XSUBSCRIBER_SUBSCRIBER_HPP
#define UMPS_MESSAGING_XPUBLISHER_XSUBSCRIBER_SUBSCRIBER_HPP
#include <memory>
...
/// @brief The subscriber in an extended publisher/subscriber messaging pattern.
