#ifndef UMPS_MESSAGING_XPUBLISHER_XSUBSCRIBER_SUBSCRIBER_OPTIONS_HPP
#define UMPS_MESSAGING_XPUBLISHER_XSUBSCRIBER_SUBSCRIBER_OPTIONS_HPP
#include <memory>
#include <string>
#include <chrono>
...
{
/// @class SubscriberOptions "publisherOptions.hpp" "umps/messaging/xPublisherXSubscriber/subscriberOptions.hpp"
/// @brief Options for initializing the subscriber in the extended
///        PUB/SUB pattern.
/// @details The subscriber receives content from a publisher by way of a 
///          proxy.
