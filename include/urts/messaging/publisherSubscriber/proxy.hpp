#ifndef URTS_MESSAGING_PUBLISHERSUBSCRIBER_PROXY_HPP
#define URTS_MESSAGING_PUBLISHERSUBSCRIBER_PROXY_HPP
#include <memory>
#include <string>
...
{
/// @class Proxy "proxy.hpp" "urts/messaging/publisherSubscriber/proxy.hpp"
